...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    var touchDistanceThreshold: CGFloat = 40.0
...
//        Set transform of node to be 20cm in front of camera
        ...
        node.simdTransform = matrix_multiply(translation, currentFrame.camera.transform)
        
        addNodeToRootScene(node)
    }
    
    func addNodeToRootScene(_ node: SCNNode) {
